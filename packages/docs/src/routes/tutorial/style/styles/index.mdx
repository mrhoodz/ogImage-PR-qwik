...
Styling is an important part of the design of a web application. Qwik is responsible for loading the style information when a component is mounted. Use [`useStyles$()`](</docs/(qwik)/components/styles/index.mdx#usestyles>) to tell Qwik which style should be loaded.
