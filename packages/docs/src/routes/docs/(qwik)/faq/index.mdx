...
For example, the "_Buy Now_" button is more important than the "_Add to Cart_" button, so Qwik will prefetch the "_Buy Now_" button first, and then the "_Add to Cart_" button.
